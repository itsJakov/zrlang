...
enum ts_symbol_identifiers {
  ...
  sym_method_decl = 28,
  sym_class_decl = 29,
  sym_class_members = 30,
  sym_class_field_decl = 31,
  sym_string_expr = 32,
  aux_sym_source_file_repeat1 = 33,
  aux_sym_call_args_repeat1 = 34,
  aux_sym_block_repeat1 = 35,
  aux_sym_class_members_repeat1 = 36,
  aux_sym_string_expr_repeat1 = 37,
};
...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [96] = {.entry = {.count = 1, .reusable = false}}, REDUCE(sym__stmt, 1, 0, 0),
  [98] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym__stmt, 1, 0, 0),
