...
static const TSParseActionEntry ts_parse_actions[] = {
  ...
  [15] = {.entry = {.count = 1, .reusable = true}}, REDUCE(aux_sym_class_decl_repeat1, 2, 0, 0),
  [17] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_decl_repeat1, 2, 0, 0), SHIFT_REPEAT(22),
  [20] = {.entry = {.count = 2, .reusable = true}}, REDUCE(aux_sym_class_decl_repeat1, 2, 0, 0), SHIFT_REPEAT(24),
  ...
  [34] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_decl, 5, 0, 6),
  [36] = {.entry = {.count = 1, .reusable = true}}, SHIFT(29),
  [38] = {.entry = {.count = 1, .reusable = true}}, SHIFT(31),
  [40] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_field_decl, 4, 0, 4),
  [42] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_block, 2, 0, 0),
  [44] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_method_decl, 7, 0, 7),
  [46] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_decl, 4, 0, 1),
  ...
  [54] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_decl, 6, 0, 3),
  [56] = {.entry = {.count = 1, .reusable = true}}, REDUCE(sym_class_decl, 7, 0, 5),
